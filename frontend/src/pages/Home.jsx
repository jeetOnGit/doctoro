  ...
  return (
    <div>
      <section className="heroSectionWrapper mt-4">
        <div className="heroSecion flex bg-[#6C63FF] text-white px-16 rounded-lg h-[450px] items-center max-[1200px]:flex-col max-[1200px]:h-fit max-[700px]:px-6 max-[700px]:pt-5">
          <div className="max-[1200px]:text-center">
            <h2 className="text-[2.7rem] font-semibold leading-snug max-[700px]:text-[1.5rem]">
              Book Appointment With Trusted Doctors
            </h2>
            <div className="flex gap-3 my-5 max-[1200px]:flex-col items-center">
              <img
                className="w-[100px] max-[1200px]:w-[70px]"
            ...
            <button className="bg-white text-[#595959] px-8 py-3 text-xs rounded-full hover:scale-105">
              <Link to="/doctors">
                Book appointment <i className="fa-solid fa-arrow-right me-2" />
              </Link>
            </button>
          </div>
          <div className="self-end max-[1200px]:self-center">
            <img
              className="max-[1200px]:w-[500px]"
      ...
      <section className="doctors">
        ...
        <button className="bg-[#EAEFFF] text-[#595959] px-8 py-3 text-center rounded-full mx-auto">
          <Link className="text-center" to="/doctors">
            more
          </Link>
        </button>
      </section>
      ...
      <section className="heroSectionWrapper mt-4 py-10">
        <div className="heroSecion flex justify-evenly bg-[#6C63FF] text-white px-16 rounded-lg h-[400px] items-center max-[1200px]:flex-col max-[1200px]:h-fit  max-[1200px]:gap-8">
          <div className="w-[50%] max-[1200px]:text-center max-[1200px]:w-fit  max-[1200px]:mt-6">
            <h2 className="text-[2.9rem] font-semibold leading-snug max-[700px]:text-[1.5rem]">
              Book Appointment With 100+ Trusted Doctors
            </h2>

            <button
              onClick={() => navigate("/login")}
              className="bg-white text-[#595959] px-8 py-4 text-xs rounded-full hover:scale-105 mt-5  max-[700px]:py-2  max-[700px]:px-4"
            >
              Create account
            </button>
          </div>
